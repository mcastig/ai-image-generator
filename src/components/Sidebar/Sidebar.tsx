...
function IconApps() {
  return (
    <svg width="22" height="22" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <rect x="13" y="2" width="9" height="9" rx="2" fill="currentColor" fillOpacity="0.3"/>
      <rect x="2" y="13" width="9" height="9" rx="2" fill="currentColor" fillOpacity="0.3"/>
      <rect x="13" y="13" width="9" height="9" rx="2" fill="currentColor" fillOpacity="0.3"/>
    </svg>
  );
}
...
function IconFolder() {
  return (
    <svg width="22" height="22" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M3 8C3 7.06812 3 6.60218 3.15224 6.23463C3.35523 5.74458 3.74458 5.35523 4.23463 5.15224C4.60218 5 5.06812 5 6 5H8.34315C9.16065 5 9.5694 5 9.93694 5.15224C10.3045 5.30448 10.5935 5.59351 11.1716 6.17157L13 8V11H3V8Z" fill="currentColor" fillOpacity="0.3"/>
      <path d="M3 11.2C3 10.0799 3 9.51984 3.21799 9.09202C3.40973 8.71569 3.71569 8.40973 4.09202 8.21799C4.51984 8 5.0799 8 6.2 8H17.8C18.9201 8 19.4802 8 19.908 8.21799C20.2843 8.40973 20.5903 8.71569 20.782 9.09202C21 9.51984 21 10.0799 21 11.2V15.8C21 16.9201 21 17.4802 20.782 17.908C20.5903 18.2843 20.2843 18.5903 19.908 18.782C19.4802 19 18.9201 19 17.8 19H6.2C5.0799 19 4.51984 19 4.09202 18.782C3.71569 18.5903 3.40973 18.2843 3.21799 17.908C3 17.4802 3 16.9201 3 15.8V11.2Z" fill="currentColor"/>
    </svg>
  );
}
...
export default function Sidebar({ mobileOpen, onMobileClose }: SidebarProps) {
  const { activeTab, theme, setActiveTab, toggleTheme, setShowSignInModal } = useStore();
      ...
      <aside className={`sidebar ${mobileOpen ? "sidebar--open" : ""}`}>
        <div className="sidebar__top">
          <div className="sidebar__logo">
            <Image src="/resources/Logo.svg" alt="Logo" width={28} height={28} />
          </div>
        ...
        <div className="sidebar__bottom">
          {session?.user ? (
            <div className="sidebar__user" ref={menuRef}>
              ...
              >
                {(session.user as Record<string, unknown>).avatarUrl ? (
                  <Image
                    src={(session.user as Record<string, unknown>).avatarUrl as string}
              ...
              {menuOpen && (
                <div className="sidebar__user-popover">
                  ...
                  >
                    <Image src="/resources/signout.svg" alt="" width={15} height={15} />
                    Sign out
                  </button>
                </div>
              )}
            ...
            <button className="sidebar__signin" onClick={() => signIn("github")}>
              <Image src="/resources/signin.svg" alt="Sign in" width={16} height={16} />
              <span>Sign In</span>
            </button>
          )}
        </div>
